...
f = open("C:\\Users\\user\\Projects\\API.txt")
key = f.read()

genai.configure(api_key=key)  # Replace with your valid API key
...
engine = pyttsx3.init()
 ...
 #st.set_page_config(page_title="ClearSight AI", layout="wide", page_icon="🧠")
st.markdown(
    """
    <style>
     .main-title {
...
st.markdown('<div class="main-title">ClearSight AI </div>', unsafe_allow_html=True)
...
st.markdown(
    ...
    <footer style="text-align:center;">
        <p>Powered by <strong>Google Gemini API</strong> | ©️  Pravith S Nair 
    </footer>
    """,
    unsafe_allow_html=True,
)
